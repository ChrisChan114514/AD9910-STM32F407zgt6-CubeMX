...
#define IUP_Pin GPIO_PIN_10
#define IUP_GPIO_Port GPIOE
#define SDI_Pin GPIO_PIN_11
#define SDI_GPIO_Port GPIOE
#define DRC_Pin GPIO_PIN_12
#define DRC_GPIO_Port GPIOE
#define DRH_Pin GPIO_PIN_13
#define DRH_GPIO_Port GPIOE
#define OSK_Pin GPIO_PIN_14
#define OSK_GPIO_Port GPIOE
#define PF0_Pin GPIO_PIN_15
